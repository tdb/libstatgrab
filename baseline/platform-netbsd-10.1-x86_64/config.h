...
/* another BSD extension */
#define HAVE_STATVFS_FIOSIZE /**/

/* NetBSD extended statvfs */
#define HAVE_STATVFS_FSTYPENAME /**/
...
#define HAVE_STRUCT_IO_SYSCTL 1
...
#define HAVE_STRUCT_UVMEXP_SYSCTL 1
